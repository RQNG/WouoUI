...
/*
  WouoUI - wave 是 WouoUI 通用版本的分支，灵感来自 macOS 程序坞的波浪效果，当前版本 v1.0
...
void setting_proc()
{
  ...
  if (btn.pressed) { btn.pressed = false; switch (btn.id) { case BTN_ID_CW: case BTN_ID_CC: list_rotate_switch(); break; case BTN_ID_LP: ui.select[ui.layer] = 0; case BTN_ID_SP: switch (ui.select[ui.layer]) {
        ...
        case 6:   window_value_init("Btn SPT",  BTN_SPT,  &ui.param[BTN_SPT],   255,  0,  1, setting_menu, M_SETTING);  break;
        case 7:   window_value_init("Btn LPT",  BTN_LPT,  &ui.param[BTN_LPT],   255,  0,  1, setting_menu, M_SETTING);  break;

        //多选框
        case 8:   check_box_m_select( LIST_UFD  );  break;
        case 9:   check_box_m_select( LIST_LOOP );  break;
        case 10:  check_box_m_select( WIN_BOK   );  break;
        case 11:  check_box_m_select( KNOB_DIR  );  break;
        case 12:  check_box_m_select( DARK_MODE );  break;

        //关于本机
        case 13:  ui.index = M_ABOUT; ui.state = S_LAYER_IN; break;
      }
    }
  }
}
